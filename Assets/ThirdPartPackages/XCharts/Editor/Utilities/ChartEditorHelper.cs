...
namespace XCharts.Editor
{
    ...
    public static class ChartEditorHelper
    {
        ...
        /// 扩展渐变系数
        /// </summary>
        /// <param name="drawRect">位置</param>
        /// <param name="heights">高度</param>
        /// <param name="key">未知key</param>
        /// <param name="prop">sp</param>
        /// <param name="relativeName">反射变量</param>
        /// <param name="compareName">比较变量</param>
        public static bool PropertyFieldAreaStyle(ref Rect drawRect, Dictionary<string, float> heights, string key,
            SerializedProperty prop, string relativeName,string compareName)
        {
            if (prop == null) return false;       

            if (relativeName.Equals(compareName))
            {
                EditorGUI.PropertyField(drawRect, prop, true);
                var mhig = EditorGUI.GetPropertyHeight(prop);
                drawRect.y += mhig;
                heights[key] += mhig;             
            }
            else
        ...
        /// <param name="heights">高度</param>
        /// <param name="key">未知key</param>
        /// <param name="parentProp">sp</param>
        /// <param name="relativeName">反射的变量</param>
        /// <param name="compareName">是否开启</param>
        public static bool PropertyField(ref Rect drawRect, Dictionary<string, float> heights, string key,
            SerializedProperty parentProp, string relativeName, string compareName)
        {
            return PropertyFieldAreaStyle(ref drawRect, heights, key, parentProp.FindPropertyRelative(relativeName),relativeName,compareName);
        }
