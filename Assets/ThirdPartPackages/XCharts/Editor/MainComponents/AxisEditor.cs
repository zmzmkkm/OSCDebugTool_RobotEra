...
namespace XCharts.Editor
{
    ...
    public class AxisEditor : MainComponentEditor<Axis>
    {
        public override void OnInspectorGUI()
        {
            ...
            if (type == Axis.AxisType.Value || type == Axis.AxisType.Time || type.Equals(Axis.AxisType.ValueTime))
            {
                ...
                if (type == Axis.AxisType.Value || type.Equals(Axis.AxisType.ValueTime))
                {
