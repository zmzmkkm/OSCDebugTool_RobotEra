...
namespace XUGL
{
    ...
    public static class UGL
    {
        ...
        public static void DrawRoundRectangle(VertexHelper vh, Rect rect,
            ...
            float smoothness = 2, bool invert = false, Sprite backgroundTexture = null)
        {
            DrawRoundRectangle(vh, rect.center, rect.width, rect.height, color, toColor, rotate, cornerRadius,
                isYAxis, smoothness, invert,backgroundTexture);
        }
            ...
            float smoothness = 2, bool invert = false, Sprite backgroundTexture = null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    // }
                    // vh.AddUIVertexQuad(s_Vertex);
                    // Material.mainTexture = backgroundTexture.texture;
        ...
        public static void DrawBorder(VertexHelper vh, Rect rect,
            ...
            bool horizontal = false, float smoothness = 1f, bool invertCorner = false, float extWidth = 0)
        {
            DrawBorder(vh, rect.center, rect.width, rect.height, borderWidth, color, toColor, rotate,
                cornerRadius, horizontal, smoothness, invertCorner, extWidth);
        }
        ...
        public static void DrawSemicircle(VertexHelper vh, Vector3 center, float radius, Color32 color, Color32 toColor,
            float startDegree, float toDegree,float gap,float smoothness, int gradientType = 0, bool isYAxis = false)
        {
            if (radius == 0) return;
