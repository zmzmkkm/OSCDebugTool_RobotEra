...
namespace XCharts.Runtime
{
    ...
    {
        private static readonly string s_SerieIconObjectName = "icon";
        ...
        protected GameObject m_SerieIconRoot;
        ...
        public override void Update()
        {
            ...
            if (serie.label != null && (serie.labelDirty || serie.label.componentDirty))
            {
                ...
                //Debug.Log("<color=yellow> InitSerieLabel-- 此处要初始icon空物体 </color>");
                InitSerieLabel();
                InitSerieIcon();
                InitSerieEndLabel();
            }
        ...
        private void InitSerieLabel()
        {
            ...
            //Debug.Log($"输出m_SerieLabelRoot父类： {m_SerieLabelRoot.transform.parent}  爷类:  {m_SerieLabelRoot.transform.parent.parent}" );
        ...
        /// 扩展初始化icon空物体
        /// </summary>
        private void InitSerieIcon()
        {
            InitRoot();
            m_SerieIconRoot = ChartHelper.AddObject(s_SerieIconObjectName, m_SerieRoot.transform,
                chart.chartMinAnchor, chart.chartMaxAnchor, chart.chartPivot, chart.chartSizeDelta);
            m_SerieLabelRoot.hideFlags = chart.chartHideFlags;
            //Debug.Log($"输出m_SerieLabelRoot父类： {m_SerieLabelRoot.transform.parent}  爷类:  {m_SerieLabelRoot.transform.parent.parent}");
        }
