...
namespace XCharts.Runtime
{
    public static class ChartHelper
    {
        ...
        {
            get { return s_Builder; }
        }

        public static Vector3 ignoreVector3
        {
            get { return s_DefaultIngoreDataVector3; }
        }
        ...
        public static GameObject AddImageItem(string name, Transform parent, Vector2 anchorMin,
            Vector2 anchorMax, Vector2 pivot, double data, Vector2 sizeDelta, Vector3 localPosition, ImageStyle iconStyle, int replaceIndex = -1)
        {
            GameObject obj;
            ...
            var rect = EnsureComponent<RectTransform>(obj);
            var image = EnsureComponent<Image>(obj);
            ...
            image.color = iconStyle.color;
            image.sprite = iconStyle.sprite;
            image.type = iconStyle.type;

            image.pixelsPerUnitMultiplier = iconStyle.sprite.rect.width / sizeDelta.x;
            if (data < 0)
            {
                obj.transform.localRotation = Quaternion.Euler(0, 180, 180);
            }
            ...
            ComponentTheme theme, string content, Color autoColor, TextAnchor autoAlignment = TextAnchor.MiddleCenter)
        {
            ...
            {
                label.color = (!labelStyle.background.autoColor || autoColor == Color.clear) ? labelStyle.background.color : autoColor;
