...
namespace XCharts.Runtime
{
    ...
    public class LabelStyle : ChildComponent, ISerieComponent, ISerieDataComponent
    {
        ...
        public bool autoRotate
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_AutoRotate, value)) SetComponentDirty();
            }
        }
        ...
        public float distance
        {
            ...
            set
            {
                if (PropertyUtil.SetStruct(ref m_Distance, value)) SetAllDirty();
            }
        }
        ...
        public TextPadding textPadding
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_TextPadding, value)) SetComponentDirty();
            }
        }
        ...
        public ImageStyle background
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_Background, value)) SetAllDirty();
            }
        }
        ...
        public IconStyle icon
        {
            ...
            set
            {
                if (PropertyUtil.SetClass(ref m_Icon, value)) SetAllDirty();
            }
        }
        ...
        {
            return m_FormatterFunction == null ? currentContent : m_FormatterFunction(labelIndex, labelIndex, category, currentContent);
        }

        protected string GetFormatterFunctionContent(int labelIndex, double value, string currentContent)
        {
            return m_FormatterFunction == null ? currentContent : m_FormatterFunction(labelIndex, value, null, currentContent);
        }
    }
}