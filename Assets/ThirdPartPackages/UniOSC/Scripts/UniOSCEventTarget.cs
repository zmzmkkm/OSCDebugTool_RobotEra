    ...
    public abstract class UniOSCEventTarget : MonoBehaviour
    {
        ...
        public bool receiveAllPorts
        {
            ...
            set
            {
                ...
                {
                    Debug.Log("<color=orange>You can't set the receiveAllPorts when using explicitConnection mode!</color>");
                    return;
                }
        ...
        [HideInInspector, SerializeField] protected string _oscAddress = "/";

        [SerializeField, HideInInspector] protected List<string> _oscAddresses = new List<string>();

        [HideInInspector, SerializeField] protected bool _receiveAllAddresses;

        [HideInInspector, SerializeField] protected bool _useExplicitConnection;

        [HideInInspector, SerializeField] protected UniOSCConnection _explicitConnection;

        [HideInInspector, SerializeField] protected int _oscPort;

        [HideInInspector, SerializeField] protected bool _receiveAllPorts;

        [SerializeField, HideInInspector] protected bool _redrawFlag;

        [SerializeField, HideInInspector] protected List<UnityEngine.Object> _foldoutList = new List<UnityEngine.Object>();
        ...
        {
            return (_useExplicitConnection || _receiveAllPorts || _oscPort == port) &&
                   (_receiveAllAddresses || _oscAddresses.Exists(adr => adr == address && !String.IsNullOrEmpty(address)));
        }
